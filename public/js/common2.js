...
var newServerUrl = "http://211.252.85.144:3000/api";
var serverUrl = "http://211.252.85.144:8080/api";
var serverUrl1 = "http://211.252.85.144:8876";
var getTr = null;
var idcheck = false;
var delayCheck = true;
...
function openMenuHeaderLogin(target, username) {
    ...
    $.ajax({
        type: "GET",
        url: newServerUrl + "/user/joinTimeInfo/" + encodeURI(username),
    ...
    $.ajax({
        type: "GET",
        url: newServerUrl + "/user/depositInfo/" + encodeURI(username),
        contentType: "application/json;charset=UTF-8",
        dataType: "json",
        error: function() {
            alert('통신실패!!');
...
function popOpenOvernight(pop, username) {
    ...
    $(".mts-pop .insert-content").load('contents/' + loadFile, function() {
        ...
        $.ajax({
            ...
            url: newServerUrl + "/user/userOvernightInfo/" + username,
            dataType: "json",
            error: function() {
                alert('통신실패!!');
            },
        ...
        $.ajax({
            ...
            url: newServerUrl + "/company/fkDepositInfo/" + username,
            dataType: "json",
            error: function() {
                alert('통신실패!!');
            },
...
function popOpenMargin(pop, username) {
    ...
    $(".mts-pop .insert-content").load('contents/' + loadFile, function() {
        ...
        $.ajax({
            type: "GET",
            url: newServerUrl + "/overnight/userOverseaInfo/" + username,
            dataType: "json",
            error: function() {
                alert('통신실패!!');
            },
        ...
        $.ajax({
            type: "GET",
            url: newServerUrl + "/overnight/userFutureInfo/" + username,
            dataType: "json",
            error: function() {
                alert('통신실패!!');
            },
...
function bankingSearch(number) {
    if (delayCheck) {
        ...
        if( ( Date.parse($('#startDate' + number).val()) <= Date.parse($('#endDate' + number).val()) ) && ( Date.parse($('#endDate' + number).val()) <= (Date.parse($('#startDate' + number).val()) + 30 * 24 * 60 * 60* 1000) ) ){
            ...
            let props;
            if (number == 1) {
                props = (username + "?bdate=" + bdate + "&edate=" + edate + "&btype=" + 0);
            } else if (number == 2) {
                props = (username + "?bdate=" + bdate + "&edate=" + edate + "&btype=" + 1);
            }
            $.ajax({
                type: "GET",
                url: newServerUrl + "/bank/history/" + props,
                dataType: "json",
                error: function() {
                    alert('통신실패!!');
                },
...
function historySearch(tab, selector) {
    if (delayCheck) {
        ...
        if( ( Date.parse($('#startDate' + tab + selector).val()) <= Date.parse($('#endDate' + tab + selector).val()) ) && ( Date.parse($('#endDate' + tab + selector).val()) <= (Date.parse($('#startDate' + tab + selector).val()) + 30 * 24 * 60 * 60* 1000) ) ){
            ...
            $.ajax({
                type: "GET",
                url: newServerUrl + "/trade/userHistory" + props,
                dataType: "json",
                error: function() {
                    alert('통신실패!!');
                },
...
function sendApiCheckid() {
    if ($('#username').val().length > 4) {
        ...
        $.ajax({
            ...
            url: newServerUrl + "/user/userIdChk/" + $('#username').val(),
            contentType: "application/json;charset=UTF-8",
            dataType: "json",
            error: function() {
                alert('통신실패!!');
...
function sendApiJoin() {
  if ($('#password').val() == $('#confirm').val() && $('#password').val()!="" && idcheck==true && $('#password').val().length > 3 && $('#email').val().length>0 && $('#name').val().length>0 && $('#phone').val().length>0 ) {
			...
			$.ajax({
				type: "GET",
				url: newServerUrl + "/user/newMember?username=" + $('#username').val().toLowerCase().replace(/ /gi, '') + "&password=" + $('#password').val() + "&name=" + $('#name').val() + "&mobile=" + $('#phone').val() + "&recommender=" + $("#recommender").val() + "&bank=" + $("#bank").val() + "&bankAccount=" + $("#bankAccount").val() + "&bankOwner=" + $("#bankOwner").val() + "&email="+$('#email').val(),
				contentType: "application/json;charset=UTF-8",
				dataType: "text",
				error: function(e) {
					alert('통신실패!!');
...
function sendApiDepositInfo(username) {
    ...
    $.ajax({
        type: "GET",
        url: serverUrl + "/deposit/depositInfo/" + username,
        contentType: "application/json;charset=UTF-8",
        dataType: "json",
        error: function(e) {
            alert('통신실패!!');
    ...
    $.ajax({
        type: "GET",
        url: newServerUrl + "/exchange/history/" + username,
        contentType: "application/json;charset=UTF-8",
        dataType: "json",
        error: function() {
            alert('통신실패!!');
...
function sendApiDepositInfo2(username) {
    if (delayCheck) {
        ...
        $.ajax({
            type: "GET",
            url: newServerUrl + "/exchange/history/" + encodeURI(username),
            contentType: "application/json;charset=UTF-8",
            dataType: "json",
            error: function() {
                alert('통신실패!!');
...
function sendApiExchange() {
    $.ajax({
        type: "GET",
        url: newServerUrl + "/exchange/currExchange",
        contentType: "application/json;charset=UTF-8",
        dataType: "json",
        error: function(e) {
            alert('통신실패!!');
...
function sendApiGetUserDeposit(username) {
    ...
    $.ajax({
        type: "GET",
        url: newServerUrl + "/user/outBalanceInfo/" + username,
        contentType: "application/json;charset=UTF-8",
        dataType: "json",
        error: function(e) {
            alert('통신실패!!');
    ...
    $.ajax({
        type: "GET",
        url: newServerUrl + "/user/bankInfo/" + encodeURI(username),
        contentType: "application/json;charset=UTF-8",
        dataType: "json",
        error: function(e) {
            alert('통신실패!!');
    ...
    $.ajax({
        type: "GET",
        url: newServerUrl + "/company/bankinfo",
        contentType: "application/json;charset=UTF-8",
        dataType: "json",
        error: function(e) {
            alert('통신실패!!');
...
function sendApiNoice() {
    setTimeout(() => {
        $.ajax({
            type: "GET",
            url: newServerUrl + "/notice/list?username=12345678910",
            contentType: "application/json;charset=UTF-8",
            dataType: "json",
            error: function(e) {
                alert('통신실패!!');
